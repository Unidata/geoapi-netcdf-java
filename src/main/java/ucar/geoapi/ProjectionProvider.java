        ...
        implements OperationMethod, ParameterDescriptorGroup
{
     ...
     *                     as tuples of {@value ucar.geoapi.AliasList#NAME_CAPACITY} elements.
     */
     ...
     * parameters for this projection and exposes the "descriptor" aspect of those objects.
     */
    @Override
    ...
    /**
     * Creates all netCDF parameters known to this provider. This method gets the list of
     * parameters for this projection and exposes the "value" aspect of those objects.
     */
    @Override
