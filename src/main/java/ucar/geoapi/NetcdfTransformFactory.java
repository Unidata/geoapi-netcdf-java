...
/**
 * Creates {@link MathTransform} instances from netCDF, OGC or EPSG parameters.
...
public class NetcdfTransformFactory implements MathTransformFactory {
     ...
     */
    private static final NetcdfTransformFactory INSTANCE = new NetcdfTransformFactory();
     ...
     * @see #getInstance()
     */
    protected NetcdfTransformFactory() {
    ...
    /**
     * Returns the default instance of math transform factory.
     *
     * @return the default factory instance.
     */
    public static MathTransformFactory getInstance() {
        return INSTANCE;
    }
     ...
     */
    @Override
    public MathTransform createFromXML(final String wkt) throws FactoryException {
        throw new FactoryException("Not supported yet.");
    }
}
