...
final class SimpleGeographicBoundingBox implements GeographicBoundingBox, Extent, Serializable {
     ...
     */
    static final SimpleGeographicBoundingBox WORLD = new SimpleGeographicBoundingBox(-180, 180, -90, 90);
     ...
     */
    SimpleGeographicBoundingBox(final GeographicBoundingBox box) {
     ...
     */
    SimpleGeographicBoundingBox(final Rectangle2D bounds) {
     ...
     */
    SimpleGeographicBoundingBox(final double westBoundLongitude,
