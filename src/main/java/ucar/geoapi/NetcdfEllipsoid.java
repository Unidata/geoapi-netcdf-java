 ...
 */
final class NetcdfEllipsoid extends NetcdfIdentifiedObject
        implements Ellipsoid, GeodeticDatum, EllipsoidalCS, GeographicCRS
{
     ...
     */
    static final NetcdfEllipsoid WGS84 = new NetcdfEllipsoid(EarthEllipsoid.WGS84);
     ...
     * @see Earth#getRadius()
     */
    static final NetcdfEllipsoid SPHERE = new NetcdfEllipsoid(Earth.DEFAULT);
     ...
     */
    NetcdfEllipsoid(final Earth earth) {
