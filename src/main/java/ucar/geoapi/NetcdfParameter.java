 ...
 * The netCDF {@code Parameter} class is both a parameter value and its own descriptor.
 * Consequently this adapter implements both the {@link ParameterValue} and
 * {@link ParameterDescriptor} interfaces.
 *
 * <p>NetCDF {@code Parameter} instances can store the following types:</p>
 * <blockquote><table class="doc">
 ...
 * </table></blockquote>
 *
 * All other {@code fooValue()} methods delegate to one of the above-cited getter methods
 ...
 */
class NetcdfParameter<T> extends NetcdfIdentifiedObject
        implements ParameterValue<T>, ParameterDescriptor<T>, Cloneable
{
    ...
    @Override
    public int hashCode() {
        return super.hashCode() + 37 * aliases.hashCode();
    }
